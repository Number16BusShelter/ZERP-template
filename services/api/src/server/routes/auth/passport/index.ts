...
export function encryptJWTPayload(payload) {
    const jwtOptions: jwt.SignOptions = {
        ...
        expiresIn: globalConfig.jwt!.expiration as string | number,
    };
...
export const issueJWTToken = async (req, res): Promise<JWTTokenResp> => {
...
if (globalConfig.app.mode == "development" || globalConfig.app.debug == true) generateTestToken();
